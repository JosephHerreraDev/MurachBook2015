...
namespace CustomerMaintenance
{
    public partial class frmCustomers : Form
    {
        ...
        private void btnAddWholesale_Click(object sender, EventArgs e)
        {
            ...
            frmAddWholesale frmAddWholesale = new frmAddWholesale();
            customer = frmAddWholesale.GetNewCustomer();
        ...
        private void btnAddRetail_Click(object sender, EventArgs e)
        {
            ...
            // and adds that customer to the customer list
            frmAddRetail frmAddRetail = new frmAddRetail();
            customer = frmAddRetail.GetNewCustomer();
